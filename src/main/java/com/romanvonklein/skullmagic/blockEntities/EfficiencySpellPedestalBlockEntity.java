...
public class EfficiencySpellPedestalBlockEntity extends BlockEntity {
    ...
    public static void tick(World world, BlockPos pos, BlockState state, EfficiencySpellPedestalBlockEntity be) {
