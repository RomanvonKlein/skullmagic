...
public class CooldownSpellPedestalBlockEntityRenderer implements BlockEntityRenderer<CooldownSpellPedestalBlockEntity> {
    public CooldownSpellPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {

    }

    public void render(CooldownSpellPedestalBlockEntity blockEntity, float tickDelta, MatrixStack matrices,
